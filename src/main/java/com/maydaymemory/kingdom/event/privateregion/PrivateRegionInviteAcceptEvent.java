...
public class PrivateRegionInviteAcceptEvent extends PrivateRegionEvent implements Cancellable {
    ...
    public PrivateRegionInviteAcceptEvent(PrivateRegion region, OfflinePlayer invitee) {
        super(region);
