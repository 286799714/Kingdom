...
public class PrivateRegionInviteEvent extends PrivateRegionEvent implements Cancellable {
    ...
    public PrivateRegionInviteEvent(PrivateRegion region, OfflinePlayer invitee) {
        super(region);
