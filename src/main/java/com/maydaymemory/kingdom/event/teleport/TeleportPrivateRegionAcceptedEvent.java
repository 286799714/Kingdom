...
public class TeleportPrivateRegionAcceptedEvent extends PlayerEvent implements Cancellable {
    private static final HandlerList handlers = new HandlerList();
    private boolean cancel = false;
    private PrivateRegion target;

    public TeleportPrivateRegionAcceptedEvent(Player who, PrivateRegion target) {
        super(who);
        this.target = target;
    }
