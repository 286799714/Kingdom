...
public class TeleportPrivateRegionRejectedEvent extends PlayerEvent implements Cancellable {
    private static final HandlerList handlers = new HandlerList();
    private boolean cancel = false;
    private PrivateRegion target;

    public TeleportPrivateRegionRejectedEvent(Player who, PrivateRegion target) {
        super(who);
        this.target = target;
    }
