...
public class RegionListGUI extends GUI{
    @LanguageInject
    ...
    public RegionListGUI(Player player, String text, PrivateRegion region,int page) {
        super(player);
        search();
        this.page=page;
    ...
    public void onClick(int slot) {
        ...
        if(inventory.getItem(slot).equals(next)){
            ...
            GUIManager.getManager().openGUI(new RegionListGUI(player,text,region,page+1));
            return;
        }
